...
<script type="text/javascript">
	...
	function clearall(listener){
		$("#message"+listener).val("");
		$("#status"+listener).html("");
	}
</script>
...
<body>
	...
	<div id="producer">
		<h2>监听</h2>
		<br>
		<textarea id="messagerefreshQueueListener1"></textarea>
		<br> <br>
		<button onclick="refresh('refreshQueueListener1')">刷新Queue监听器1</button>
		<button onclick="clearall('refreshQueueListener1')">清除</button>
		<br> <span id="statusrefreshQueueListener1"></span> <br>
		<textarea id="messagerefreshQueueListener2"></textarea>
		<br> <br>
		<button onclick="refresh('refreshQueueListener2')">刷新Queue监听器2</button>
		<button onclick="clearall('refreshQueueListener2')">清除</button>
		<br> <span id="statusrefreshQueueListener2"></span> <br>
		<textarea id="messagerefreshTopicListener1"></textarea>
		<br> <br>
		<button onclick="refresh('refreshTopicListener1')">刷新Topic监听器1</button>
		<button onclick="clearall('refreshTopicListener1')">清除</button>
		<br> <span id="statusrefreshTopicListener1"></span> <br>
		<textarea id="messagerefreshTopicListener2"></textarea>
		<br> <br>
		<button onclick="refresh('refreshTopicListener2')">刷新Topic监听器2</button>
		<button onclick="clearall('refreshTopicListener2')">清除</button>
		<br> <span id="statusrefreshTopicListener2"></span> <br>
		<h3>
			<a href="send.jsp">返回发送页面</a>
		</h3>
	</div>
